...
abs_path = '/cluster/work/users/ovewh/wet_deposition_sensitivity_sims/FINE_silt_no_rain_scav'
...
SPEC = Species_Params(
    ...
    PDQUER = '20.0E-06', # Particle size, mean diameter
    ...
    PCRAIN_AERO ='0.000000'
)

RELEASES = Releases(COMMENT = 'COARSE-SILT',
                    PARTS='200000')
