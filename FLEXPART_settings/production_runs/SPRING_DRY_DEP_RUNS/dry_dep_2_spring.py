...
abs_path = '/cluster/work/users/ovewh/emission_sensitivities_spring/2018'
...
flexpart_input_path = '/cluster/projects/nn2806k/ovewh/flexpart/FLEXPART_input/'
...
IND_RECEPTOR = '4', #1, Concentration,  3 Wet Deposition, 4 Dry depostion
...
SPEC = Species_Params(
    ...
    PIN_AERO  = '0.100000', #Ice Nuclei efficency, (suggested value 0.1)
